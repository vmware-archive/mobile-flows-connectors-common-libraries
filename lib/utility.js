...
const botDiscoverySchema = require('../schemas/bot-discovery.json')
...
/**
 * Returns an object containing validation and error informations.
 * @param {object} cardMetadata - the card metadata json response as an object 
 */
...
/**
 * Returns an object containing validation and error informations.
 * @param {object} botDiscoveryMetadata - the botDiscovery metadata json response as an object 
 */
const validateBotDiscovery = (botDiscoveryMetadata) => {
  const ajv = new Ajv();
  return {
    valid: new Ajv().validate(botDiscoverySchema, botDiscoveryMetadata),
    errors: ajv.errors
  };
}
