...
/**
 * Returns true if test discovery schema is in compliance with base discovery schema.
 * https://vmware-samples.github.io/card-connectors-guide/#schema/connector-discovery-schema.json
 * @param {string} baseSchemaPath - path to base discovery schema
 * @param {string} testSchemaPath - path to test discovery schema
 */
