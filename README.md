...
The function takes in a string of discovery metadata json response. Returns an object containing validation and error  
informations. The key properties of the returned object are "valid" and "errors".  
